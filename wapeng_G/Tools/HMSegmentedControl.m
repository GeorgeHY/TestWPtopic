...
- (void)setDefaults {
    ...
    self.opaque = NO;
    //    self.selectionIndicatorColor = [UIColor colorWithRed:52.0f/255.0f green:181.0f/255.0f blue:229.0f/255.0f alpha:1.0f];R128G141B157
    
//    self.selectionIndicatorColor = [UIColor colorWithRed:128.0f/255.0f green:141.0f/255.0f blue:157.0f/255.0f alpha:1.0f];//选中之后 下面的小条～～～～
...
- (void)drawRect:(CGRect)rect {
    ...
    UIImage *image = [UIImage imageNamed:@"tab_focus"];
    self.selectionIndicatorBoxLayer.contents = (id) image.CGImage;
    ...
    //    self.selectionIndicatorBoxLayer.borderColor = (__bridge CGColorRef)[UIColor colorWithRed:73.0f/255.0f green:82.0f/255.0f blue:89.0f/255.0f alpha:1.0f];
    ...
    if (self.type == HMSegmentedControlTypeText) {
        [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
            ...
            //            UIImage *image = [UIImage imageNamed:@"tab_focus.png"];
            //            [self.selectionIndicatorBoxLayer setBackgroundColor:(__bridge CGColorRef)[UIColor colorWithRed:225.0/255.0f green:225.0/255.0f blue:225.0/255.0f alpha:1]];
            //            self.selectionIndicatorBoxLayer.backgroundColor = (__bridge CGColorRef)[UIColor colorWithRed:73.0f/255.0f green:82.0f/255.0f blue:89.0f/255.0f alpha:1.0f];
