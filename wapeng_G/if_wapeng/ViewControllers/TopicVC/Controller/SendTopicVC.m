...
#define kLabelH  30
@interface SendTopicVC ()<UITextFieldDelegate>
{
...
-(NSMutableDictionary*)setSendTopicParam
{
    NSMutableDictionary * param = [[NSMutableDictionary alloc]  init];
    [param  setValue:D_ID forKey:@"D_ID"];
    [param  setValue:self.title forKey:@"topic.title"];
    [param  setValue:self.contentText forKey:@"topic.content"];
    
//    [param  setValue: forKey:@"topic.searchWord"];
    return param;
...
-(void)sendAciticity{
    ...
    NSLog(@"发送活动");
    [http  sixReuqestUrl:TOP_1_2_6 postDict:[self setSendTopicParam] succeed:^(AFHTTPRequestOperation *operation, NSObject *obj, BOOL succeed) {
